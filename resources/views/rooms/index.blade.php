...
@push('styles')
    <style>
        .floor-filter-btn { background: white; color: #3A3632; border: 1px solid #cfc4b8; }
        .floor-filter-btn.active { background: #43bac4; color: white; border-color: #43bac4; }
        .floor-filter-btn:hover:not(.active) { background: #e8ded2; }
    </style>
@endpush
